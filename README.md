...
因此，我做了一个决定，将知识点整理成小册，叫《Terraform 101 从入门到实践》。该小册会不断增加和完善内容，所以初期会有很多不完美的地方。如果大家有问题可以提Issue，但前期不会处理。**因为工作变动和育儿的原因，我需要学习和适应，没有ETA，慢慢更新吧**。

但Terraform的基本概念是已经介绍了的，了解与入门是够用了。我会尽量在工作之余、带娃之余、睡觉之余挤时间完成。这篇文章也算是立个Flag，并自我监督吧。
